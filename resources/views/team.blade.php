...
<!--==================================================-->
<div class="team-area style-inner">
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
						...
						<div class="team-content">
							...
							<div class="team-social-icon">
								<ul>
									...
									<li class="list-line"><a href="#">twitter</a></li>
									<li><a href="#">behance</a></li>
								</ul>
							</div>
						</div>
						<img src="assets/images/inner/team-inner.png" alt="thumb">
					</div>
				</div>
			</div>
			<div class="col-xl-3 col-lg-4 col-md-6">
				<div class="single-team-box">
					<div class="single-team-thumb">
						...
						<img src="assets/images/inner/team-inner2.png" alt="thumb">
					</div>
				</div>
			</div>
			<div class="col-xl-3 col-lg-4 col-md-6">
				<div class="single-team-box">
					<div class="single-team-thumb">
						...
						<img src="assets/images/inner/team-inner-3.png" alt="thumb">
					</div>
				</div>
			</div>
			<div class="col-xl-3 col-lg-4 col-md-6">
				<div class="single-team-box">
					<div class="single-team-thumb">
						...
						<img src="assets/images/inner/team-inner4.png" alt="thumb">
					</div>
				</div>
			</div>
		</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-6 col-md-12">
				<div class="address-box wow fadeInUp animated">
			...
			<div class="col-lg-6 col-md-12">
				<div class="address-box2 wow fadeInUp animated">
					<div class="address-icon">
