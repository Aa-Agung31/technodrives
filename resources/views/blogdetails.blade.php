						...
						<div class="widget-sidber">
							...
							<div class="sidber-widget-recent-post">
								...
								<div class="recent-widget-content">
									<a href="{{ route('blogdetails') }}">Regional Manager limited time
										</a>	
									<p> feb, 26 2024</p>							
								</div>
							</div>							
							<div class="sidber-widget-recent-post">
								...
								<div class="recent-widget-content">
									<a href="{{ route('blogdetails') }}">The Complete App Development</a>	
									<p> June, 15 2024</p>							
								</div>
							</div>							
							<div class="sidber-widget-recent-post">
								...
								<div class="recent-widget-content">
									<a href="{{ route('blogdetails') }}">Easy and Most Powerful Server</a>	
									<p> april, 10 2024</p>							
								</div>
							</div>
						</div>							
