			...
			<div class="col-lg-6">
				<div class="about-section-content">
					<div class="section-title text-left">
						...
						<h1 class="section-main-title">Transformer</h1>
						<!-- <h1 class="section-main-title">Switchgear</h1> -->
						<p class="section-title-descr" style="text-align: justify;">The Leaflet Transformer REV 1.pdf highlights Technodrives’ expertise in transformer testing and maintenance, including oil analysis, DGA, and advanced diagnostics like SFRA, Tan Delta, and Partial Discharge. It emphasizes international standards, proven project experience, and strong HSE practices to ensure transformer safety, reliability, and long-term performance.</p>
					</div>
					<div class="about-list-item">
						<ul>
							<li><img src="assets/images/home-two/about-icon2.png" alt="icon">Diagnostics – Oil, DGA, SFRA, Tan Delta, PD tests.</li>
							<li><img src="assets/images/home-two/about-icon2.png" alt="icon">Reliability – Proven projects, strong HSE practices.</li>
						</ul>
					</div>
		...
		<div class="row align-items-center">
			<div class="col-lg-12">
				<div class="section-title text-center">
					...
					<h1 class="section-main-title">Main Service</h1>
			...
			<div class="col-xl-4 col-lg-4 col-md-6">
				<div class="service-single-box">
					...
					<div class="service-content">
						<h3 class="service-title">Transformer Oil Analysis</h3>
						<p class="service-text">Oil analysis detects faults in transformers, preventing failures from discharges, thermal stress, and costly breakdowns.</p>
			...
			<div class="col-xl-4 col-lg-4 col-md-6">
				<div class="service-single-box">
					...
					<div class="service-content">
						<h3 class="service-title">Transformer Electrical Test</h3>
						<p class="service-text">Electrical static tests ensure transformer condition and reliability, detecting hidden faults using international standards.</p>
						<!-- <div class="service-btn">
							<a href="{{ route('servicedetails') }}"><i class="fas fa-plus"></i> READ MORE</a>
						</div> -->
					</div>
			...
			<div class="col-xl-4 col-lg-4 col-md-6">
				<div class="service-single-box">
					...
					<div class="service-content">
						<h3 class="service-title">Dissolved Gas Analysis</h3>
						<p class="service-text">DGA effectively detects potential transformer faults by analyzing gases in oil through sampling, extraction, and evaluation.</p>
						<!-- <div class="service-btn">
							<a href="{{ route('servicedetails') }}"><i class="fas fa-plus"></i> READ MORE</a>
						</div> -->
					</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				<div class="section-title text-center">
					<h5 class="section-sub-title">PT. Technodrives</h5>
					<h1 class="section-main-title">Comprehensive Transformer Testing</h1>
		...
		<div class="row">
			<div class="col-lg-4 col-md-6">
				<div class="single-service-box">
					<div class="service-box-inner">
						<div class="service-content">
							<h4 class="service-title">Transformer Diagnostic Tests</h4>
							<p class="service-des">Key diagnostic methods include SFRA, DIRANA, and insulation resistance with polarization index to assess transformer condition and reliability.
							</p>
						</div>
						<div class="service-icon">
			...
			<div class="col-lg-4 col-md-6">
				<div class="single-service-box">
					<div class="service-box-inner">
						<div class="service-content">
							<h4 class="service-title">Electrical Tests</h4>
							<p class="service-des">Essential tests include winding resistance, Tan Delta, and turn ratio to evaluate transformer performance and insulation reliability.
							</p>
						</div>
						<div class="service-icon">
			...
			<div class="col-lg-4 col-md-6">
				<div class="single-service-box">
					<div class="service-box-inner">
						<div class="service-content">
							<h4 class="service-title">Advanced Transformer Tests</h4>
							<p class="service-des">Short circuit impedance, partial discharge, and Hipot tests ensure transformer safety, reliability, and long-term performance.
							</p>
						</div>
						<div class="service-icon">
